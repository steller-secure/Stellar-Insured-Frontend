...
const CategoryCard = ({ icon, title, description, iconBgColor }: CategoryCardProps) => {
  return (
    <div className=" border border-[#94BCCA] rounded-lg p-6 hover:bg-slate-800/70 transition-colors duration-300">
      <div className={`w-16 h-16 ${iconBgColor} rounded-lg flex items-center justify-center mb-4`}>
        <img
          src={icon}
          alt={`${title} icon`}
          width={34}
