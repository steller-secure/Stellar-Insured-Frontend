...
export function WalletConnectButton({
  ...
  const { showWalletConnected, showWalletDisconnected, showWalletError } =
    useNotifications();
  ...
  const getErrorInfo = () => {
    ...
    if (
      ...
      return {
        ...
        suggestion:
          "Please install the Freighter wallet browser extension and refresh the page.",
      };
    }
    ...
    if (errorLower.includes("rejected") || errorLower.includes("denied")) {
      return {
        code: "USER_REJECTED",
        suggestion:
          "You cancelled the connection. Please try again if you wish to proceed.",
      };
    }
    ...
    if (errorLower.includes("sign")) {
      return {
        code: "SIGNING_FAILED",
        suggestion:
          "Failed to sign the transaction. Please check your wallet settings and try again.",
      };
    }
    ...
    return {
      code: "WALLET_ERROR",
      suggestion:
        "An error occurred while connecting to your wallet. Please try again.",
    };
  };
      ...
      {connectionStatus === "error" && error && (
        <div className="flex flex-col gap-3">
          <FeedbackState
            ...
            actionLabel={
              errorInfo.code === "WALLET_NOT_INSTALLED"
                ? "Install Wallet"
                : undefined
            }
            onAction={
